...
class EditAccountsTest(AccsTest):
    ...
    def test_save_button(self):
        ...
        self.assertEqual(
            b"mypass", account.password, "password of edited account is incorrect!"
        )
        self.assertEqual("Tom", account.name, "name of edited account is incorrect!")
        self.assertEqual(
            "tom@gmail.com", account.email, "email of edited account is incorrect!"
        )
        self.assertEqual(
            "10.07.1997", account.date, "date of edited account is incorrect!"
        )
        self.assertEqual(
        ...
        self.assertFalse(
            account.copy_email, "Copy e-mail of edited account is incorrect!"
        )
    ...
    def test_no_changes(self):
        ...
        self.assertTrue(
            account.copy_email,
            "Copy e-mail of account that was edited, but "
    ...
    def test_edit_attached_files(self):
        ...
        self.assertTrue(
            ...
            "Attach list of edit account form must have `pyqt5.py` " "file in it!",
        )

        # it has `somefile.txt` as well
        self.assertTrue(
            model.findItems("somefile.txt"),
            "Attach list of edit account form must have `somefile.txt` " "file in it!",
        )
        ...
        self.assertEqual(
            ...
            {"somefile.txt": None, "pyqt5.py": None},
        ...
        self.assertEqual(
            form.attached_files.model().rowCount(),
            2,
